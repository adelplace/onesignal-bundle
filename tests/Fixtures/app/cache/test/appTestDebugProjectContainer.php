...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'onesignal.api' => 'getOnesignal_ApiService',
    ...
    /**
     * Gets the public 'onesignal.api' shared service.
     *
     * @return \OneSignal\OneSignal
     */
    protected function getOnesignal_ApiService()
    {
        $a = new \OneSignal\Config();
        $a->setApplicationId('my application id');
        $a->setApplicationAuthKey('my application auth key');
        $a->setUserAuthKey('my user auth key');

        return $this->services['onesignal.api'] = new \OneSignal\OneSignal($a, new \GuzzleHttp\Client());
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('JIOZjiofsesiu');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdelplaceOneSignalBundle' => 'Adelplace\\OneSignalBundle\\AdelplaceOneSignalBundle',
            ),
            'kernel.bundles_metadata' => array(
                ...
                'AdelplaceOneSignalBundle' => array(
                    'parent' => NULL,
            ...
            'adelplace_one_signal.application_id' => 'my application id',
            'adelplace_one_signal.application_auth_key' => 'my application auth key',
            'adelplace_one_signal.user_auth_key' => 'my user auth key',
